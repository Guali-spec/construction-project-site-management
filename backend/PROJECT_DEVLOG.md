...
- Auth r�elle (login/register/refresh + /auth/me)
...
**Changements backend :**
- `/auth/me` retourne d�sormais le profil utilisateur complet
...
**Objectif :**
Mettre en place le socle multi-tenancy c�t� API avec versioning, format d�erreurs standard, guard PENDING et endpoints admin.

**Changements majeurs :**
- Pr�fixe global API : `/api/v1`
- Format d�erreurs standardis� `{ code, message, details, path, timestamp }`
- Guard `PENDING` (deny-all sauf routes auth autoris�es)
- Endpoints admin companies + users pending/company-scoped
- companyId inject� dans JWT et scoping appliqu� aux modules projets
...
### [2026-02-09] Session � Phase C2 (Governance r�les globaux)

**Objectif :**
Mettre en place l�attribution des r�les globaux avec matrice d�autorisation, audit et tests.

**Nouveaux endpoints :**
- `PATCH /api/v1/admin/users/:id/role`

**D�cisions cl�s :**
- Matrice d�assignation respect�e (SUPER_ADMIN, ADMIN_ENTREPRISE, CHEF_PROJET)
- Interdiction de changer son propre r�le
- Interdiction inter-company pour non SUPER_ADMIN
- Audit log syst�matique (ActivityLog)
